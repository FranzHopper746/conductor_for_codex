...
for s in conductor-setup conductor-status conductor-implement conductor-newTrack conductor-revert conductor-review conductor-check-upstream conductor-context update-conductor; do
...
skill_names=(conductor-setup conductor-status conductor-implement conductor-newTrack conductor-revert conductor-review conductor-check-upstream conductor-context update-conductor)
