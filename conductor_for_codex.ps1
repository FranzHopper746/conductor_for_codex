...
$skillNames = @('conductor-setup','conductor-status','conductor-implement','conductor-newTrack','conductor-revert','conductor-review','conductor-check-upstream','conductor-context','update-conductor')
